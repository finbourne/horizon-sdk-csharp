...
using System.IO;
using System.Linq;
using SdkConfiguration = Finbourne.Horizon.Sdk.Client.Configuration;
...
namespace Finbourne.Horizon.Sdk.Extensions
{
    ...
    public class ApiConfigurationBuilder
    {
        private static readonly Dictionary<string, string> ConfigNamesToEnvVariables = new Dictionary<string, string>()
            {
                ...
                { nameof(ApiConfiguration.BaseUrl), "FBN_HORIZON_URL" },
        ...
        private static readonly Dictionary<string, string> ConfigNamesToSecrets = new Dictionary<string, string>()
        {
            ...
            { nameof(ApiConfiguration.BaseUrl), "horizonUrl" },
        ...
        private static ApiConfiguration BuildFromEnvironmentVariables(ConfigurationOptions? opts)
        {
            ...
            var apiConfig = new ApiConfiguration
            {
                ...
                BaseUrl = Environment.GetEnvironmentVariable("FBN_HORIZON_URL") ??
                          Environment.GetEnvironmentVariable("FBN_FINBOURNE-HORIZON_API_URL") ?? 
                          Environment.GetEnvironmentVariable("fbn_finbourne-horizon_api_url") ?? 
                          Environment.GetEnvironmentVariable("FBN_FINBOURNE_HORIZON_API_URL") ?? 
                          Environment.GetEnvironmentVariable("fbn_finbourne_horizon_api_url"),
