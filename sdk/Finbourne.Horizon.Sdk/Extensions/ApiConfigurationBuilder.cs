    ...
    public class ApiConfigurationBuilder
    {
        ...
        {            
            var apiConfig = new ApiConfiguration
            {
                ...
                BaseUrl = Environment.GetEnvironmentVariable("FBN_FINBOURNE-HORIZON_API_URL") ?? Environment.GetEnvironmentVariable("fbn_finbourne-horizon_api_url"),
