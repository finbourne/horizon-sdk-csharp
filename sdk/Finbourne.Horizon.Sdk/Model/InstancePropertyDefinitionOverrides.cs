...
namespace Finbourne.Horizon.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "InstancePropertyDefinitionOverrides")]
    public partial class InstancePropertyDefinitionOverrides : IEquatable<InstancePropertyDefinitionOverrides>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InstancePropertyDefinitionOverrides" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InstancePropertyDefinitionOverrides() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InstancePropertyDefinitionOverrides" /> class.
        /// </summary>
        ...
        public InstancePropertyDefinitionOverrides(string displayNameOverride = default(string), string descriptionOverride = default(string), string entityType = default(string), List<string> entitySubType = default(List<string>), List<string> vendorPackage = default(List<string>))
        {
            // to ensure "entityType" is required (not null)
            if (entityType == null)
            {
                throw new ArgumentNullException("entityType is a required property for InstancePropertyDefinitionOverrides and cannot be null");
            }
        ...
        {
            return this.Equals(input as InstancePropertyDefinitionOverrides);
        }

        /// <summary>
        /// Returns true if InstancePropertyDefinitionOverrides instances are equal
        /// </summary>
        /// <param name="input">Instance of InstancePropertyDefinitionOverrides to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InstancePropertyDefinitionOverrides input)
        {
            if (input == null)
            {
                return false;
