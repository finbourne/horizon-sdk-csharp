...
namespace Finbourne.Horizon.Sdk.Api
{
    ...
    public interface IRunsApiSync : IApiAccessor
    {
        ...
        Finbourne.Horizon.Sdk.Client.ApiResponse<WorkflowRunResultsResponse> GetWorkflowRunResultsWithHttpInfo(string runId, int operationIndex = 0, ConfigurationOptions? opts = null);
        /// <summary>
        ...
        Finbourne.Horizon.Sdk.Client.ApiResponse<Object> StopInstanceExecutionWithHttpInfo(string instanceId, string runId, int operationIndex = 0, ConfigurationOptions? opts = null);
    ...
    public interface IRunsApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<Finbourne.Horizon.Sdk.Client.ApiResponse<WorkflowRunResultsResponse>> GetWorkflowRunResultsWithHttpInfoAsync(string runId, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), ConfigurationOptions? opts = null);
        /// <summary>
        /// [EXPERIMENTAL] RerunInstance: Reruns a single instance execution.
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<Finbourne.Horizon.Sdk.Client.ApiResponse<Object>> StopInstanceExecutionWithHttpInfoAsync(string instanceId, string runId, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), ConfigurationOptions? opts = null);
    ...
    public partial class RunsApi : IRunsApi
    {
        ...
        {
            Finbourne.Horizon.Sdk.Client.ApiResponse<WorkflowRunResultsResponse> localVarResponse = GetWorkflowRunResultsWithHttpInfo(runId, opts: opts);
            return localVarResponse.Data;
        }
        ...
        /// <param name="opts">Options for this request.</param>
        /// <returns>ApiResponse of WorkflowRunResultsResponse</returns>
        public Finbourne.Horizon.Sdk.Client.ApiResponse<WorkflowRunResultsResponse> GetWorkflowRunResultsWithHttpInfo(string runId, int operationIndex = 0, ConfigurationOptions? opts = null)
        {
            // verify the required parameter 'runId' is set
            if (runId == null)
            {
                throw new Finbourne.Horizon.Sdk.Client.ApiException(400, "Missing required parameter 'runId' when calling RunsApi->GetWorkflowRunResults");
            }
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Get<WorkflowRunResultsResponse>("/api/runs/{runId}/workflow/results", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
        ...
        {
            Finbourne.Horizon.Sdk.Client.ApiResponse<WorkflowRunResultsResponse> localVarResponse = await GetWorkflowRunResultsWithHttpInfoAsync(runId, operationIndex, cancellationToken, opts).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="opts">Options for this request.</param>
        /// <returns>Task of ApiResponse (WorkflowRunResultsResponse)</returns>
        public async System.Threading.Tasks.Task<Finbourne.Horizon.Sdk.Client.ApiResponse<WorkflowRunResultsResponse>> GetWorkflowRunResultsWithHttpInfoAsync(string runId, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), ConfigurationOptions? opts = null)
        {
            // verify the required parameter 'runId' is set
            if (runId == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<WorkflowRunResultsResponse>("/api/runs/{runId}/workflow/results", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        {
            Finbourne.Horizon.Sdk.Client.ApiResponse<Object> localVarResponse = StopInstanceExecutionWithHttpInfo(instanceId, runId, opts: opts);
            return localVarResponse.Data;
        }
        ...
        /// <param name="opts">Options for this request.</param>
        /// <returns>ApiResponse of Object</returns>
        public Finbourne.Horizon.Sdk.Client.ApiResponse<Object> StopInstanceExecutionWithHttpInfo(string instanceId, string runId, int operationIndex = 0, ConfigurationOptions? opts = null)
        {
            // verify the required parameter 'instanceId' is set
            if (instanceId == null)
            {
                throw new Finbourne.Horizon.Sdk.Client.ApiException(400, "Missing required parameter 'instanceId' when calling RunsApi->StopInstanceExecution");
            }

            // verify the required parameter 'runId' is set
            if (runId == null)
            {
                throw new Finbourne.Horizon.Sdk.Client.ApiException(400, "Missing required parameter 'runId' when calling RunsApi->StopInstanceExecution");
            }
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Put<Object>("/api/runs/{instanceId}/{runId}/stop", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
        ...
        {
            Finbourne.Horizon.Sdk.Client.ApiResponse<Object> localVarResponse = await StopInstanceExecutionWithHttpInfoAsync(instanceId, runId, operationIndex, cancellationToken, opts).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="opts">Options for this request.</param>
        /// <returns>Task of ApiResponse (Object)</returns>
        public async System.Threading.Tasks.Task<Finbourne.Horizon.Sdk.Client.ApiResponse<Object>> StopInstanceExecutionWithHttpInfoAsync(string instanceId, string runId, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), ConfigurationOptions? opts = null)
        {
            // verify the required parameter 'instanceId' is set
            if (instanceId == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PutAsync<Object>("/api/runs/{instanceId}/{runId}/stop", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
